...
python main.py \
    --config /home/cjrathod/projects/def-mhassanz/cjrathod/HAMBA/options/journal_model_tiny.yaml\
    ...
    --checkpoint_folder /home/cjrathod/projects/def-mhassanz/cjrathod/HAMBA/chkpts/X2_tiny