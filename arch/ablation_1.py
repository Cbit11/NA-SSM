...
# H, W= 64, 64
# device = 'cuda'
# input_tensor= torch.rand(8, dims,H, W).to('cuda') 
# model = Ablation_Model(img_size= 64,in_chans= 3, patch_size=1,dims=128,input_resolution=64).to('cuda')
...
# # 3. Profile Memory
# optimizer = torch.optim.Adam(params= model.parameters(), lr = 1e-4, betas= ([.99,.99]))
# loss_fn = nn.L1Loss()
# torch.cuda.reset_peak_memory_stats()
...
#     print(f"Model static size: {size_all_mb:.2f} MB")
